...
export function SortDropdown({ value, onChange }: SortDropdownProps) {
  ...
  return (
    <div className="relative flex-shrink-0" ref={ref}>
      <button
        className="flex items-center h-[33px] gap-1.5 px-3 text-[12px] font-medium whitespace-nowrap
          ...
          hover:border-foreground/30 hover:text-foreground text-muted-foreground"
      ...
      {open && (
        <div className="absolute top-[calc(100%+4px)] right-0 min-w-[140px] max-h-[200px] overflow-y-auto bg-sidebar border border-border rounded-lg shadow-[0_4px_12px_hsl(0_0%_0%/0.3)] z-[1000] animate-in fade-in-0 slide-in-from-top-1 duration-150">
